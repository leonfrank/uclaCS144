...
<% 
   ...
   int maxTotal = (Integer)request.getAttribute("maxTotal");
%>
    ...
    <body>
        <div class= "PagePart">    
			...
			<div class="col-md-6 col-md-offset-3 text-center">
				<form role="form" class="FormContent" action="/eBay/search" method="GET">
					...
					<div class="col-md-11 form-group" style="overflow: hidden;">
						<input class="form-control" name="q" type="text" autocomplete="off" id="query" placeholder="Enter Keywords :)"/>    		
			...
			<div class="col-md-6 col-md-offset-3">
				...
				<%
				if (numResultsToSkip+numResultsToReturn < maxTotal)
				{
				%>
				...
				<%int pageEnd = numResultsToSkip+numResultsToReturn>maxTotal ? maxTotal: numResultsToSkip+numResultsToReturn;%>
				<p> Item Returned: <%=pageStart%> ~ <%=pageEnd%> / <%=maxTotal%> </p>
			</div>
